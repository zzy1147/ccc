...
public class GiftAnimation {
    ...
    private void updateView(final ChatRoomMessage message, ViewGroup root) {
        ...
        TextView giftText = (TextView) root.findViewById(com.netease.nim.chatroom.demo.R.id.gift_name);
        giftText.setText(GiftConstant.titles[attachment.getGiftType().getValue()]);

        ImageView giftImage = (ImageView) root.findViewById(com.netease.nim.chatroom.demo.R.id.gift_image);
