package com.snz.rskj.android.widget;
...
//    private LinearLayout llTest1, llTest2, llTest3, llTest4, llTest5, llTest6, llTest7, llTest8;
    ...
    private void _createView(final Context context) {
        rootVew = LayoutInflater.from(context).inflate(R.layout.choos_live_vide_layout, null);
    ...
    private void initLayout(Context context) {
         ...
         btLive = rootVew.findViewById(R.id.bt_live);
                 btVideo =  rootVew.findViewById(R.id.bt_video);
        addImage=rootVew.findViewById(R.id.pop_iv_img);
...
//
        addImage.setOnClickListener(new MViewClick(0, context));
//
        btLive.setOnClickListener(new MViewClick(1, context));
        btVideo.setOnClickListener(new MViewClick(2, context));
...
//        llTest8.setOnClickListener(new MViewClick(8, context));
    ...
    private void _openPopupWindowAction() {
        ObjectAnimator objectAnimator = ObjectAnimator.ofFloat(addImage, "rotation", 0f, 135f);
        objectAnimator.setDuration(200);
        objectAnimator.start();

        _startAnimation(btLive, 500, animatorProperty);
        _startAnimation(btVideo, 430, animatorProperty);
...
//        _startAnimation(llTest8, 500, animatorProperty);
    ...
    public void _rlClickAction() {
        if (addImage != null ) {
            ...
            ObjectAnimator objectAnimator = ObjectAnimator.ofFloat(addImage, "rotation", 135f, 0f);
            objectAnimator.setDuration(300);
            objectAnimator.start();

            _closeAnimation(btVideo, 300, top);
            _closeAnimation(btLive, 200, top);

            addImage.postDelayed(new Runnable() {
                @Override
                public void run() {
                    _close();
                }
