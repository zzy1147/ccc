package com.snz.rskj.android.view.animator;
...
public class LoveLayout extends RelativeLayout {
    ...
    private void initView() {
        ...
        // 图片资源
        icons[0] = getResources().getDrawable(R.drawable.button_lips_blue);
        icons[1] = getResources().getDrawable(R.drawable.button_lips_pink);
        icons[2] = getResources().getDrawable(R.drawable.button_lips_red);
        icons[3] = getResources().getDrawable(R.drawable.button_lips_blue);
