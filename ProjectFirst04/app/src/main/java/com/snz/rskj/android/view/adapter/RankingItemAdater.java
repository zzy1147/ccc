...
public class RankingItemAdater extends RecyclerView.Adapter<RankingItemAdater.ViewHolder> implements View.OnClickListener {
    ...
    public RankingItemAdater(Context context, List<RankingBean> mList) {
