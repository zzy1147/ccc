package com.snz.rskj.android.activitylive.inputmodule;
...
import com.snz.rskj.android.model.listview.AutoRefreshListView;

import com.snz.rskj.android.model.listview.MessageListViewEx;
...
//        MessageAudioControl.getInstance(container.activity).stopAudio(); // 界面返回，停止语音播放
    ...
    private void initListView() {
        ...
        messageListView = (MessageListViewEx) rootView.findViewById(com.netease.nim.chatroom.demo.R.id.messageListView);
    ...
    private class MsgItemEventListener implements MsgAdapter.ViewHolderEventListener {
        ...
        private void showReDownloadConfirmDlg(final IMMessage message) {
            ...
            final EasyAlertDialog dialog = EasyAlertDialogHelper.createOkCancelDiolag(container.activity, null,
                    container.activity.getString(com.netease.nim.chatroom.demo.R.string.repeat_download_message), true, listener);
            dialog.show();
        }
