...
import com.snz.rskj.android.activitylive.InteractionMember;
...
public class MicHelper {
    ...
    public void sendLinkNotify(String roomId, InteractionMember member) {
        ...
        Log.e(TAG, "member.getAvChatType().getValue():" + member.getAvChatType().getValue());
