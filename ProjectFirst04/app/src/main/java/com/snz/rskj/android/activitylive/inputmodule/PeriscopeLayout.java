...
public class PeriscopeLayout extends RelativeLayout {
    ...
    private void init() {
        ...
        Drawable red = getResources().getDrawable(com.netease.nim.chatroom.demo.R.drawable.pl_red);
        Drawable yellow = getResources().getDrawable(com.netease.nim.chatroom.demo.R.drawable.pl_yellow);
        Drawable blue = getResources().getDrawable(com.netease.nim.chatroom.demo.R.drawable.pl_blue);
